...
export const api = {
  ...
  startStep2: (sessionId: string) => apiRequest<{ flowId: string; flowUrl: string; proxyType: ProxyType; reused?: boolean }>('/api/step2/start', { method: 'POST', body: JSON.stringify({ sessionId }) }),
